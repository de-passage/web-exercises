...
oddTimesOdd OneOdd m = oddPlusEven m $ evenTimesOdd ZeroEven m
oddTimesOdd (NextOdd n) m = oddPlusEven m $ evenTimesOdd (oddPlusOne n) m
...
oddTimesEven OneOdd m = evenPlusEven m $ evenTimesEven ZeroEven m
oddTimesEven (NextOdd n) m = evenPlusEven m $ evenTimesEven (oddPlusOne n) m